% ========================================================================
% 初始化
% [Dinit,Tinit,Winit,Q] = initialization4LCKSVD(training_feats,....
%                               H_train,dictsize,iterations,sparsitythres)
% Inputs
%       training_feats  -training features训练数据的特征
%       H_train         -label matrix for training feature标签 
%       dictsize        -number of dictionary items字典大小
%       iterations      -iterations迭代次数
%       sparsitythres   -sparsity threshold稀疏度
% Outputs
%       Dinit           -initialized dictionary初始的字典
%       Tinit           -initialized linear transform matrix
%       Winit           -initialized classifier parameters初始的分类参数
%       Q               -optimal code matrix for training features 最佳的编码矩阵
% ========================================================================
